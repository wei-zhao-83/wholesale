    ...
    <ul id="sidebar-menu">
        ...
        <li>
            ...
            <ul>
                ...
                <li><a  class="<?php if($this->router->fetch_module() == 'returns') { ?>active<?php } ?>" href="<?php echo base_url('admin/returns/create'); ?>">Return</a></li>
                <li><a  class="<?php if($this->router->fetch_module() == 'report') { ?>active<?php } ?>" href="<?php echo base_url('admin/sale/report'); ?>">Report</a></li>
