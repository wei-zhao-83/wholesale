...
namespace Proxies\__CG__\customer\models;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class Customer extends \customer\models\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'email', 'phone', 'fax', 'description', 'shipping_address', 'shipping_city', 'shipping_province_abbr', 'shipping_postal', 'billing_address', 'billing_city', 'billing_province_abbr', 'billing_postal', 'deleted_at', 'tags', 'images', 'contacts', 'credits', 'sales', 'returns');
    }
